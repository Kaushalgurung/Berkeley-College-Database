...
namespace Berkely_College.Controllers
{
    public class StudentResultController : Controller
    {
        ...
        public StudentResultController(ModelContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string id)
        {
            ...
            ViewBag.results = (await _context.ModuleResult.FromSqlRaw($"select * from Module_Result where Student_Id in  (select Student_ID from Student_Module where student_id = '{id}')").ToListAsync());
